...
public class LexerTests {
	...
	@Test
	void testIllegalFloat3() throws LexicalException
	{
		String input = ".0";
		show(input);
		ILexer lexer = getLexer(input);
	...
	@Test
	void testIllegalFloat4() throws LexicalException
	{
		String input = ".1";
		show(input);
		ILexer lexer = getLexer(input);
	...
	@Test
	void testNotAFloat() throws LexicalException
	{
		String input = "123,45";
		show(input);
		ILexer lexer = getLexer(input);
		checkInt(lexer.next(), 123);
		checkToken(lexer.next(), Kind.COMMA, 0, 3);
		checkInt(lexer.next(), 45);
	}

	@Test
	void testIllegalIdent1() throws LexicalException
	{
		String input = "@test";
		show(input);
		ILexer lexer = getLexer(input);
	...
	@Test
	void testIllegalIdent2() throws LexicalException
	{
		String input = "t@est";
		show(input);
		ILexer lexer = getLexer(input);
	...
	@Test
	void testIllegalChar1() throws LexicalException
	{
		String input = "\\";
		show(input);
		ILexer lexer = getLexer(input);
	...
	@Test
	void testIllegalChar2() throws LexicalException
	{
		String input = "@";
		show(input);
		ILexer lexer = getLexer(input);
	...
	@Test
	void testIllegalChar3() throws LexicalException
	{
		String input = ".";
		show(input);
		ILexer lexer = getLexer(input);
	...
	@Test
	public void testTotallyEmpty() throws LexicalException
	{
		String input = "";
		show(input);
		ILexer lexer = getLexer(input);
	...
	@Test
	void testGeneral() throws LexicalException
	{
		String input = """
				abc
				00.4
	...
	@Test
	public void testIllegalEscape() throws LexicalException
	{
		String input = """
				"\\y"
				""";
